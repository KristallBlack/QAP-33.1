...
def test_active_tab(browser, username):
    ...
    invalid_ls при ручном переключении таба на ЛС принимается системой в качестве ЛС, в
...
def test_auth_page_email_valid(browser):
    ...
    time.sleep(20)     # на случай появления капчи, необходимости ее ввода вручную
    page.btn_click_enter()
